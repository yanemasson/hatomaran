...
function constructYamlInteger(data) {
  var value = data, sign = 1, ch2, base, digits = [];
...
var grayMatterBrowser = matter["default"] = matter.matter = matter;
const matter$1 = /* @__PURE__ */ getDefaultExportFromCjs(grayMatterBrowser);
export {
  HashRouter as H,
  Link as L,
  Routes as R,
