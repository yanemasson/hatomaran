import { r as reactExports, j as jsxRuntimeExports, L as Link, u as useParams, H as HashRouter, R as Routes, a as Route, c as createRoot } from "./vendor-543a3a55.js";
(function polyfill() {
...
const ProjectPage = () => {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex flex-col items-center mt-20", children: [
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsx(Anchor, { to: project.bechanceLink, children: "Bechance link" })
  ] });
};
function App() {
