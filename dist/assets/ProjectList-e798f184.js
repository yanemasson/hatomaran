...
import { I as Image, u as useProjects } from "./useProjects-603073cf.js";
import { T as Text, a as TextVariant, u as useMediaBreakpoint } from "./index-b29bba1b.js";
...
const ProjectCard = ({ images, animations, title, isOpen }) => {
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: " flex flex-col p-3 gap-3 rounded justify-center bg-white", children: [
    images[0] && /* @__PURE__ */ jsxRuntimeExports.jsx(Image, { className: " lg:h-[85vh]", src: `${images[0].url}?nf_resize=fit&w=800`, alt: images[0].url }),
